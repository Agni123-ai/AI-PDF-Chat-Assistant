...
st.markdown('<p class="main-title">📄 Multi-PDF Chat Assistant</p>', unsafe_allow_html=True)
st.markdown('<p class="subtitle">Upload PDFs and ask questions from them using Gemini AI</p>', unsafe_allow_html=True)
